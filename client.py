...
#!/usr/bin/python
"""
Created on Mon Dec 19 09:09:37 2016
...
class SSDPMessage(object):
    ...
    values.
    """
    def __init__(self, multicast_addr='239.255.255.250', multicast_port=1900):
        self.start_line = ''
        self._headers = {}
        self._host = ''
...
class SSDPNotifyMessage(SSDPMessage):
    """ """
...
class SSDPResponseMessage(SSDPMessage):
    """ """
